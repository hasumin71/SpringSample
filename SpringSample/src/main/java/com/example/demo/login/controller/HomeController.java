...
public class HomeController {
	...
	public String postUserDetailUpdate(@ModelAttribute SignupForm form,
		...
		//コントローラークラスでtry~catch文を使うことにより、データベースで例外が発生しても引き続き画面を表示するようにしています。
		try {
			//更新実行 
	...
	//アドミン権限専用画面のget用メソッド
	@GetMapping("/admin")
	public String geetAdmin(Model model) {
		//コンテンツ部分にユーザー詳細を表示するための文字列を登録
		model.addAttribute("contents","login/admin::admin contents");
